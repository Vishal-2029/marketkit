...
class MarketPlanCard extends StatelessWidget {
  final MarketPlanModel plan;
  final bool isCurrentPlan;
  final bool isProcessing;
  final VoidCallback onBuyTap;

  const MarketPlanCard({
    super.key,
    required this.plan,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _FeatureRow(
            label: plan.feeDiscountPct > 0
                ? '${plan.feeDiscountPct}% fee discount'
                : 'No fee discount',
            enabled: plan.feeDiscountPct > 0,
          ),
          const SizedBox(height: 8),
          _FeatureRow(
            label: 'Featured seller badge',
            enabled: plan.featuredSeller,
          ),

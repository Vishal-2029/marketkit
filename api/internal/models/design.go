...
type Design struct {
	...
	// CategoryID is nullable so pre-existing designs aren't broken by this
	...
	Category *DesignCategory `gorm:"foreignKey:CategoryID;constraint:OnDelete:SET NULL" json:"category,omitempty"`

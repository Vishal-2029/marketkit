...
// ProductCategory is a 2-level tree (parent section + child sub-section) used
// to group marketplace products on the Product Market home page. Names start
...
type ProductCategory struct {
	...
	// else fits; selecting it reveals Product.CategoryOther for a free-text
	...
	// Product Market home page. Nil until an admin uploads one, in which case
	// the app falls back to the first product's own preview image instead.
